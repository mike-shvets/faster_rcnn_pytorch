# --------------------------------------------------------
# 
# Adaptation of pascal_vol.py by Ross Girshik to SpaceNet asVOC data
...
import ds_utils
from .spacenet_eval import voc_eval
...
class spacenet(imdb):
    def __init__(self, image_set, data_path=None):
        imdb.__init__(self, 'spacenet_' + image_set)
        self._image_set = image_set
        self._data_path = self._get_default_path() if data_path is None \
            else data_path
        self._data_path = os.path.join(self._data_path)
        ...
        assert os.path.exists(self._data_path), \
            'SpaceNet path does not exist: {}'.format(self._data_path)
        assert os.path.exists(self._data_path), \
    ...
    def _load_image_set_index(self):
        ...
        # self._data_path + /SpaceNet/asVOC/trainval.txt
    ...
    def _get_default_path(self):
        """
        Return the default path where SpaceNet is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'SpaceNet')
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._data_path, 'results', 'SpaceNet')
